        ...
        cardInstances: [
            {
                ...
                cardElements: [
                    ...
                    `BAR-8RA.`,
                    {
                        html: `I was named <span class="font-weight-flux-0 animation-duration-5">BARBARA--</span>`,
                        template: 'Text0'
                    },
                    `And marketed with a cute cartoon...`,
                    {
                        goTo: 'card-instance-0-1',
                        // html: `<span class='hightlight-class'>YoYoYo</span>`, // uses the innerHTML setting
                        text: 'Pheasant',
                        template: 'Option9', 
                        callback: () => {
                            store.setValue('mascot', 'pheasant')
                        }
                    },
                    {
                        goTo: 'card-instance-0-1',
